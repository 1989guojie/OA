...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body class="leftmenubody">
 	<div class="topdivyc">
    	<a href="javascript:void(0);" class="a_link" title="隐藏菜单栏" id="nav_title"><img src="${ctx}/images/system/left_yc.gif" onclick= "ShowNav(this);"/><!--隐藏时反显示的图片<img src="images/left_xs.gif" />--></a>
    </div>
